 ...
 *  
 */
package com.cengage.sso.storefront.controllers.pages;
...
import com.cengage.sso.storefront.breadcrumb.Breadcrumb;
...
import com.cengage.sso.storefront.forms.GuestForm;
import com.cengage.sso.storefront.forms.LoginForm;
import com.cengage.sso.storefront.forms.RegisterForm;
import com.cengage.sso.storefront.forms.validation.RegistrationValidator;
import com.cengage.sso.storefront.security.AutoLoginStrategy;
import com.cengage.sso.storefront.security.GUIDCookieStrategy;
			...
			final RedirectAttributes redirectModel) throws CMSItemNotFoundException
	{
		...
		try
		{
			...
			try
			{
				...
				final CLPerson person = new CLPerson();
				person.setUid(form.getEmail());
				person.setUserPassword(form.getPwd());
				person.setGivenName(form.getFirstName());
				person.setC("Canada");
				person.setCn("CA");
				person.setMail(form.getEmail());
				person.setDepartmentNumber("11111");
				person.setEmployeeNumber("222222");
				person.setOu("arvato");
				person.setL("toronto");
				person.setInstructor(false);
				person.setHomePhone("4161112222");
				person.setHomePostalAddress("90210");
				person.setSn(form.getLastName());

				final SSOwsResult result = clsso.addUser(token, person);
